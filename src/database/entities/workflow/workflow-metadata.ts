import { AssetType, BlockDefProperties, MonkeyTaskDefTypes } from '@inf-monkeys/vines';
import { Column, Entity } from 'typeorm';
import { BaseAssetEntity } from '../assets/base-asset.js';
import { WorkflowTriggerType } from './workflow-trigger.js';
